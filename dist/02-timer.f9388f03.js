...
const options = {
    ...
    onClose (selectedDates) {
        ...
        const startButton1 = document.querySelector("[data-start]");
...
startButton.addEventListener("click", ()=>{
    const selectedDate = (0, _flatpickrDefault.default).parseDate(document.querySelector("#datetime-picker").value);
    startCountdown(selectedDate);
    startButton.setAttribute("disabled", "disabled");
});
const datetimePicker = (0, _flatpickrDefault.default)("#datetime-picker", options);
...
},{"flatpickr":"llQu5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","flatpickr/dist/flatpickr.css":"kNfue"}],"llQu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"kNfue":[function(require,module,exports) {
